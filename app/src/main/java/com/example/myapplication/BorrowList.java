...
public class BorrowList extends AppCompatActivity {
    private BorrowListAdapter adapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_borrow_list);
       ...
       String uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        ...
        //Query query1 = firebaseFirestore.collection("borrowList").whereEqualTo("uid",uid).orderBy("uid").orderBy("issueDate", Query.Direction.DESCENDING);



//                .whereEqualTo("uid",uid);
                //.orderBy("issueDate", Query.Direction.DESCENDING);
        query1 = firebaseFirestore.collection("borrowList")
                .orderBy("issueDate",Query.Direction.DESCENDING);
        ...
        adapter1 = new BorrowListAdapter(options1, BorrowList.this);
