...
public class BorrowListAdapter extends FirestoreRecyclerAdapter<com.example.myapplication.borrowListModel, BorrowListAdapter.BookHolder> {

    Context context;

    public BorrowListAdapter(@NonNull FirestoreRecyclerOptions<com.example.myapplication.borrowListModel> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull BookHolder holder, int position, @NonNull com.example.myapplication.borrowListModel model) {
        ...
        holder.txtEmail.setText("Issued to: "+model.getEmail());
        Glide.with(context)
    ...
    public static class BookHolder extends RecyclerView.ViewHolder {
        TextView txtTitle, txtAuthor, txtIssueDue, txtId, txtReturn,txtEmail;
